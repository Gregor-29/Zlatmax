(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            const rangeLenght = document.querySelector("#rangeLenght");
            if (rangeLenght) {
                nouislider.create(rangeLenght, {
                    start: [ 90, 100 ],
                    connect: true,
                    step: 1,
                    range: {
                ...
                let Frominput = document.querySelector("#input_from");
                let Toinput = document.querySelector("#input_to");
                const inputsId = [ Frominput, Toinput ];
                rangeLenght.noUiSlider.on("update", (function(values, handle) {
                    inputsId[handle].value = Math.round(values[handle]);
                }));
                const setRangeSlider = (i, value) => {
                    let arr = [ null, null ];
                    arr[i] = value;
                    rangeLenght.noUiSlider.set(arr);
                };
                inputsId.forEach(((el, index) => {
                    el.addEventListener("change", (e => {
                        setRangeSlider(index, e.currentTarget.value);
                    }));
                }));
            ...
            const rangeWidthBlade = document.querySelector("#rangeWidthBlade");
            if (rangeWidthBlade) {
                nouislider.create(rangeWidthBlade, {
                    start: [ 90, 100 ],
                    connect: true,
                    step: 1,
                    range: {
                ...
                let frominput = document.querySelector("#inputfrom");
                let toinput = document.querySelector("#inputto");
                const idinputs = [ frominput, toinput ];
                rangeWidthBlade.noUiSlider.on("update", (function(values, handle) {
                    idinputs[handle].value = Math.round(values[handle]);
                }));
                const setRangeSlider = (i, value) => {
                    let arr = [ null, null ];
                    arr[i] = value;
                    rangeWidthBlade.noUiSlider.set(arr);
                };
                idinputs.forEach(((el, index) => {
                    el.addEventListener("change", (e => {
                        setRangeSlider(index, e.currentTarget.value);
                    }));
                }));
        ...
        function initSliders() {
            if (document.querySelector(".leftSliderBlock__slider")) new core(".leftSliderBlock__slider", {
                ...
                pagination: {
                    el: ".slide-leftBlock__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".swiper-button-prev",
                ...
                on: {
                    init: function(swiper) {
                        console.log(swiper);
                        const generalFraction = document.querySelector(".fractionSlide-leftBlock__general");
                        const currentFraction = document.querySelector(".fractionSlide-leftBlock__current");
                        generalFraction.innerHTML = swiper.slides.length;
                        swiper.on("slideChange", (function() {
                            let currentSlide = ++swiper.realIndex;
                            currentFraction.innerHTML = currentSlide;
                        }));
                        const mainSlider = document.querySelector(".leftSliderBlock__slider");
            ...
            if (document.querySelector(".cardSlider__slider")) new core(".cardSlider__slider", {
                ...
                on: {
                    init: function(swiper) {
                        const mainSlider = document.querySelector(".cardSlider__slider");
                        mainSlider.addEventListener("mouseenter", (function(e) {
                            swiper.autoplay.stop();
                        }));
                        mainSlider.addEventListener("mouseleave", (function(e) {
            ...
            if (document.querySelector(".leftNew__slider")) new core(".leftNew__slider", {
                modules: [ Navigation, Autoplay, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                on: {
                    init: function(swiper) {
                        const mainSlider = document.querySelector(".leftNew__slider");
                        mainSlider.addEventListener("mouseenter", (function(e) {
                            swiper.autoplay.stop();
                        }));
                        mainSlider.addEventListener("mouseleave", (function(e) {
            ...
            if (document.querySelector(".cardSlider__slider_flashlight")) new core(".cardSlider__slider_flashlight", {
                modules: [ Navigation, Autoplay, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                on: {
                    init: function(swiper) {
                        const flashlight = document.querySelector(".cardSlider__slider_flashlight");
                        flashlight.addEventListener("mouseenter", (function(e) {
                            swiper.autoplay.stop();
                        }));
                        flashlight.addEventListener("mouseleave", (function(e) {
                            swiper.autoplay.start();
                        }));
                    }
                }
            });
            if (document.querySelector(".sliderOne__slider")) {
                const thumbsSwiper = new core(".sliderOne__slider", {
        ...
        da.init();
        const mobile = document.querySelector(".mobilei-leftblock__number");
        const mobileList = document.querySelector(".mobilei-leftblock__items");
        let someNum = 0;
        if (mobile) mobile.addEventListener("click", (function(e) {
            ++someNum;
            console.log("someNum=", someNum);
            mobile.classList.toggle("_open-number");
            if (mobileList) mobileList.classList.toggle("_open-item");
            if (mobile.closest("._open-number") && someNum >= 2) mobile.setAttribute("href", "tel:8-800-777-49-67"); else mobile.setAttribute("href", "#");
        }));
        const openArrowOne = document.querySelector("#open-arrow-one");
        const openArrowTwo = document.querySelector("#open-arrow-two");
        const underLine = document.querySelector("#open-underlist");
        document.querySelector("._open-two-link");
        document.addEventListener("click", (function(e) {
            const targetElement = e.target;
            console.log(targetElement);
            if (targetElement.closest("#open-list-one") || targetElement.closest("#open-list-two")) {
                if (targetElement.closest("#open-list-one")) {
                    openArrowOne.classList.toggle("_open-one-link");
                    if (targetElement.closest("._open-one-link")) {
                        openArrowTwo.classList.remove("_open-two-link");
                        underLine.classList.add("_openUnder");
                    } else underLine.classList.remove("_openUnder");
                }
                if (targetElement.closest("#open-list-two")) {
                    openArrowTwo.classList.toggle("_open-two-link");
                    if (targetElement.closest("._open-two-link")) {
                        openArrowOne.classList.remove("_open-one-link");
                        underLine.classList.add("_openUnder");
                    } else underLine.classList.remove("_openUnder");
                }
            } else if (targetElement.closest(".underList")) underLine.classList.add("_openUnder"); else {
                underLine.classList.remove("_openUnder");
                openArrowOne.classList.remove("_open-one-link");
                openArrowTwo.classList.remove("_open-two-link");
            }
            if (targetElement.closest(".top-underlist__item_back")) {
                underLine.classList.toggle("_openUnder");
                openArrowOne.classList.remove("_open-one-link");
                openArrowTwo.classList.remove("_open-two-link");
            }
        }));
